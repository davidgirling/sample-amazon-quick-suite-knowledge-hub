...
7) Select **Microsoft SharePoint Online Integration** then **Next** <br>
 <br>
![Configuration form](images/image_5.png)
 <br><br>
   ...
   **Authorization URL** (Not needed for **Service authentication**): <br>
   ...
   **Note**: `{your_tenant_id}` is copied from step 5).<br><br>
